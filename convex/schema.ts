...
export default defineSchema({
  ...
  runs: defineTable({
    ...
    narrationStatus: v.optional(v.union(v.literal("passed"), v.literal("failed"))),
    narrationError: v.optional(v.string()),
    createdAt: v.number(),
    updatedAt: v.number(),
  ...
  generations: defineTable({
    ...
    selectedConcept: v.optional(v.string()), brandBible: v.optional(v.string()), creativeGrammar: v.optional(v.string()), visualBible: v.optional(v.string()), title: v.string(), script: v.optional(v.union(v.string(), v.null())), shotList: v.string(),
