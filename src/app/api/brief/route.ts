...
brandProduct must clearly state what is being advertised or what story is being told. audience must name one specific person in a specific situation, never a broad category or group. Bad: "History enthusiasts and general viewers interested in Indian history." Good: "A 14-year-old preparing for a CBSE history exam who finds the textbook dull." proposition must be one concrete, stop-scrolling hook with a specific detail or tension, never a textbook summary. Bad: "The Revolt of 1857 marked the first major resistance against colonial rule in India." Good: "In 1857, a rumour about greased cartridges set an empire on fire." Choose one supported platform and one to three supported visual tones. For cinematic briefs, use "New Hook" for testObjective, an empty testObjectiveOther, and use preserveDetails for factual, cultural, character or setting details that must remain respectful and accurate. For performance briefs, choose the most useful supported testObjective and use preserveDetails only when continuity is genuinely required.
